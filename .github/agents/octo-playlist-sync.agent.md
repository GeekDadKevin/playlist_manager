...
2. Inspect the direct download integration points before wiring downloads.
...
6. Connect confirmed matches to the built-in Deezer workflow so downloads can trigger when needed.
